...
<!-- CREATE A DATA STRUCTURE TO TRACK AND MANAGE THE CONDITIONS-->
<!-- MAYBE SORT THE RES, THEN USE REDUCE FUNCTION TO COMPATE CURRENT ID & DATE WITH THE ACCUMULATORS ID & DATE, CHANGING ACCEPTED IF TRUE. DON'T FORGET TO FIND A WAY TO CHECK OTHER CONDITIONS-->
